...
function serializeAccount(doc) {
  ...
  return {
    ...
    challenge: { phase: metadata.challengePhase || null, status: metadata.challengeStatus || null, externalChallengeId: metadata.challengeId || null, payoutStatus: metadata.payoutStatus || null },
  };
}
