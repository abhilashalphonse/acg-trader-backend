...
const tradingAccountSchema = new Schema({
  ...
  financialRevision: { type: Number, required: true, min: 0, default: 0 },
  riskSequence: { type: Number, required: true, min: 0, default: 0 },
  riskProcessedSequence: { type: Number, required: true, min: 0, default: 0 },
  riskProcessingState: { type: String, enum: ['READY', 'RISK_UNRESOLVED'], required: true, default: 'READY', index: true },
  riskExpectedSequence: { type: Number, min: 1, default: null },
  riskNextAvailableSequence: { type: Number, min: 1, default: null },
  riskUnresolvedAt: { type: Date, default: null },
  riskUnresolvedReason: { type: String, default: null },
