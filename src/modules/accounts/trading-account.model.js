...
const tradingAccountSchema = new Schema({
  ...
  financialRevision: { type: Number, default: 0, min: 0 },
  riskSequence: { type: Number, default: 0, min: 0 },
  lastEvaluatedRiskSequence: { type: Number, default: 0, min: 0 },
  riskProcessingState: { type: String, enum: ['RESOLVED', 'RISK_UNRESOLVED'], default: 'RESOLVED', index: true },
  riskUnresolvedReason: { type: String, default: null },
  riskUnresolvedSince: { type: Date, default: null },
