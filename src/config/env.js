...
const DURABLE_PERSIST_TIMEFRAMES = new Set(REQUIRED_TIMEFRAMES);
...
const schema = z.object({
  ...
  MARKET_CANDLE_LEGACY_CLEANUP_ENABLED: booleanFromEnv.default(false),
  MARKET_CANDLE_LEGACY_CLEANUP_BATCH_SIZE: positiveInt(500),
  MARKET_CANDLE_LEGACY_CLEANUP_DELAY_MS: positiveInt(100),
...
const env = Object.freeze({
  ...
  market: Object.freeze({
    ...
    legacyCleanup: Object.freeze({
      enabled: raw.MARKET_CANDLE_LEGACY_CLEANUP_ENABLED,
      batchSize: raw.MARKET_CANDLE_LEGACY_CLEANUP_BATCH_SIZE,
      delayMs: raw.MARKET_CANDLE_LEGACY_CLEANUP_DELAY_MS,
    }),
